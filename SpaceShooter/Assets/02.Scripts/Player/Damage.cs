...
public class Damage : MonoBehaviour
{
    ...
    // 충돌한 Collider의 IsTrigger 옵션이 체크됐을 대 발생
    ...
    void PlayerDie()
    {
        ...
        // Debug.Log("PlayerDie!");
        // GameObject[] enemies = GameObject.FindGameObjectsWithTag(enemyTag); // "ENEMY" 태그로 지정된 모든 적 캐릭터를 추출해 배열에 저장

        // 배열의 처음부터 순화하면서 적 캐릭터의 OnPlayerDie 함수를 호출
